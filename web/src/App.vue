...
<div id="app">
  <header id="outbreak-header">
    <nav class="navbar navbar-expand-lg navbar-dark w-100 bg-grey__lighter nav-hero">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <router-link data-toggle="collapse" data-target=".navbar-collapse" class="nav-link" to="/" :class="{ active: $route.name == 'Home' }">Home
            </router-link>
          </li>
          <li class="nav-item">
  ...
  <Warning v-if="siteDown" :animate="false" :text="
          'Our site is undergoing maintenance and is currently down. We apologize for the inconvenience.'
        "></Warning>
