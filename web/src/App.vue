    ...
    <nav class="navbar navbar-expand-lg navbar-dark w-100 bg-grey__lighter nav-hero">
      ...
      <div class="collapse navbar-collapse" id="navbarNav" v-if="!$route.meta.hideNavigation">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link data-toggle="collapse" data-target=".navbar-collapse" class="nav-link" to="/data" :class="{ active: $route.name == 'Data' }">Tables
            </router-link>
          </li>
          ...
          <li class="nav-item">
            <router-link data-toggle="collapse" data-target=".navbar-collapse" class="nav-link" to="/sources" :class="{ active: $route.name == 'Sources' }">Data
            </router-link>
          </li>
