...
<div>
  ...
  <p class="m-0">
    ...
    <span class="code" v-html="'2.5 quantile of	&beta;(x + 0.5, n - x + 0.5)'"></span> to <span class="code" v-html="'97.5 quantile of &beta;(x + 0.5, n - x + 0.5)'"></span>. Sequences with collection dates specifying only
