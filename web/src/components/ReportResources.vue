...
<div class="border-top border-bottom pt-3 pb-2">
  ...
  <!-- PAGINATION -->
  <div class="pagination mt-2 d-flex align-items-center justify-content-between w-50 m-auto" v-if="total">
...
library.add(faArrowLeft, faArrowRight, faSpinner, faSearch, faInfoCircle, faChevronUp, faChevronDown);
