...
<div class="horizontal-bargraph d-flex flex-column text-left">
  ...
  <svg :width="width" :height="height">
    <g :transform="`translate(${margin.left}, ${margin.top})`" ref="horizontal_bargraph">
    </g>
    <g :transform="`translate(${width - margin.right + 3}, ${margin.top})`" class="horizontal-bargraph-y axis--y" ref="yAxis"></g>
  </svg>
</div>
</template>
