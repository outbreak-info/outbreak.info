<template>
  <div class="at-a-glance box-shadow p-2 position-relative mx-20">
        ...
        <div class="d-flex flex-column router-link-black mini-graphs mt-2 p-1">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted" v-if="data.voc"
              >Cumulative prevalence since detection</small
            >
          </div>
          ...
          <small class="text-muted" v-else> No known sequencing </small>
        </div>
      </router-link>
    </div>
