...
<div>
  ...
  <SARSMutationMap :mutationKey="mutationName" :geneColorScale="colorScale" :lineageMutations="mutations" :additionalMutations="additionalMutations" class="mb-3" v-if="mutations || additionalMutations" :copyable="true" />
