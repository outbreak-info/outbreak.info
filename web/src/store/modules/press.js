const state = {
  press: [
    ...
    {
      url:
        'https://www.theatlantic.com/science/archive/2021/06/coronavirus-tests-variants/619112/',
      img: 'atlantic.svg',
    ...
    {
      url:
        'https://www.statnews.com/2021/04/23/souped-up-existing-covid-tests-shortcut-tracking-variants/',
      img: 'stat.svg',
      title:
    ...
    {
      url:
        'https://www.latimes.com/california/story/2021-01-27/san-diego-zoo-gorillas-close-to-full-recovery-from-covid-19',
      img: 'latimes.svg',
      title:
    ...
    {
      url:
        'https://www.cnn.com/2021/06/15/health/delta-variant-of-concern-cdc-coronavirus/index.html',
      img: 'cnn.svg',
    ...
    {
      url:
        'https://www.newsweek.com/stealth-omicron-ba-2-covid-sub-variant-all-us-states-latest-1683097',
      img: 'newsweek.svg',
      title:
    ...
    {
      url:
        'https://fortune.com/2022/08/04/ba-4-6-omicron-subvariant-covid-ba-5-booster-vaccine/',
      img: 'fortune.svg',
      title:
    ...
    {
      url:
        'https://www.cbsnews.com/news/covid-ba2-omicron-sub-variant-cases-cdc/',
      img: 'cbs.svg',
      title:
    ...
    {
      url:
        'https://www.theatlantic.com/health/archive/2022/03/omicron-subvariant-new-covid-wave/627094/',
      img: 'atlantic.svg',
    ...
    {
      url:
        'https://www.latimes.com/opinion/story/2022-02-21/omicron-variants-covid-pandemic-vaccines',
      img: 'latimes.svg',
      title: "Op-Ed: Omicron won't be the last coronavirus variant to haunt us",
      publisher: 'The Los Angeles Times',
      date: 'February 2022',
      order: 8,
    },
