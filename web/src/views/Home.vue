...
<!-- NOTICES -->
<section id="notices" class="bg-highlight py-2 px-3 text-light fa-sm">
  The outbreak.info <a href="https://api.outbreak.info/" class="text-light" target="_blank">API</a> & <a href="https://outbreak-info.github.io/R-outbreak-info/" class="text-light" target="_blank">R package</a> is now live! Access all SARS-CoV-2 variant data, Research Library metadata, and cases & deaths data from outbreak.info. <a href="" target="_blank" class="mx-3 text-light">Learn more</a>
</section>
      ...
      <div class="col-sm-12 col-md-4 px-5 py-3 d-flex flex-column justify-content-between variants-intro">
        ...
        <div id="search-lineage">
          ...
          <small id="sBar-example-variant-lineage" class="form-text d-block text-left ml-5"> <span class="mr-2">Try:</span>
            ...
            <span class="mr-3">
              <router-link :to="{name: 'MutationReport', query: {pango: 'BA.2'}} " class="text-light">BA.2
                <font-awesome-icon :icon="['fas', 'angle-double-right']" />
              </router-link>
            </span>
            <span class="mr-3">
