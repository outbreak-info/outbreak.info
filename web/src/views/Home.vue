        ...
        >
          <div class="row d-flex align-items-center p-3">
            ...
            >
              ...
              <p class="text-light my-1">
                Researchers, health officials, and the public can track the
                pandemic using data on cases, deaths, and genomic variants, and
                stay updated on related research through interactive
                visualizations, a searchable library, and downloadable raw data.
              </p>
            </div>
            ...
            >
              ...
              <span class="mr-3">
                <router-link
                  :to="{
                    name: 'MutationReport',
                    query: { pango: 'B.1.1.7', selected: 'GBR' },
                  }"
                  class="text-light"
                  >B.1.1.7 / Alpha
                  <font-awesome-icon :icon="['fas', 'angle-double-right']" />
