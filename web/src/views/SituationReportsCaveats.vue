...
<div class="container text-left my-5">
  ...
  <section id="caveat-overview" class="my-4">
    ...
    <p class="w-75">
      Additionally, sequencing techniques can bias this sampling. For instance, the majority of <router-link :to="{ name:'SituationReport', params: { mutation: 'B.1.1.7'} }">B.1.1.7 genomes</router-link> identified in the United States to date were
