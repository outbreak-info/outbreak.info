<template>
<div class="my-5 mx-4 full-page text-left">
  ...
  <div class="row">
    <section id="intro" class="col-sm-6 col-md-8 pr-4">
      <div class="font-size-2">
        Concerns surrounding a new strain of SARS-CoV-2, the virus behind the COVID-19 pandemic, have been developing. <b class="text-highlight">B.1.1.7</b> lineage, also known as <b>Variant of Concern 202012/01 (VOC-202012/01)</b> or <b>20B/501Y.V1</b>, was first identified in the UK in early December 2020 and has since been detected in the US and other counties. This is of growing concern because it has shown to be significantly more transmissible than other variants.
      </div>
  ...
  <section class="my-3">
    <h4>Methodology</h4>
    <p class="m-0">
      All SARS-CoV sequences were downloaded from the <a href="https://www.gisaid.org/" rel="noreferrer" target="_blank">GISAID Initiative</a> on {{ dateUpdated }} and aligned to reference sequence <a :href="refSeq.url" target="_blank" rel="noreferrer">{{refSeq.name}}</a>.
    </p>
    <small class=""><a @click="downloadGISAID" href="">Download associated GISAID IDs</a></small>
    <Warning class="mt-2" text="B.1.1.7 genomes in the US were identified by S-gene target failures (SGTF) in community-based diagnostic PCR testing. Since this is not an unbiased approach, it does not indicate the true prevalence of the B117 lineage in the US.  <a class='text-light text-underline' href='https://outbreak.info/situation-reports/caveats'>How to interpret this report</a>"/>
...
export default {
  ...
  data() {
    return {
      ...
      refSeq: {url: "https://www.ncbi.nlm.nih.gov/nuccore/NC_045512.2/", name: "NC_045512"},
      reportType: "lineage",
      lastUpdated: "2 hours",
