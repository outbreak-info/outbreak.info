<template>
  <div class="container my-5">
    ...
    <p class="text-muted text-left">
      View mutation frequency over time for SARS-CoV-2 sequences deposited in
      the
      <a href="https://www.gisaid.org/" target="_blank" rel="noreferrer">
        GISAID Initiative
      </a>
      .
      <b>Please note that this is a biased sample:</b>
      since only a fraction of the COVID-19 cases have been sequenced, this
      analysis is not a representation of the true mutation frequency.
    </p>
    ...
    <section id="mutations-by-gene">
      ...
      <img src="@/assets/test_nonsyn.png" class="w-100" />
    </section>
  </div>
</template>
