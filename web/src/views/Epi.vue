<template>
  <div class="full-page py-5 bg-light">
    ...
    <div
      class="text-center m-auto p-2 bg-grey__lightest"
      style="max-width:700px;"
      v-if="variable.includes('Increase') && dataLength > 1"
    >
      <label class="b-contain m-auto">
    ...
    <Warning
      :animate="false"
      class="my-4"
      v-if="variable == 'testing_positivity'"
    ...
    <Warning
      ...
      class="my-4"
      v-if="noData"
      text="No results. Testing/hospitalization data are currently only available for U.S. States (not Metro areas or Counties), and recovery data is not available for the U.S."
    ></Warning>
