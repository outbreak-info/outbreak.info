  ...
  <section id="world_total" v-if="total" class="container my-5">
    <div class="row">
      ...
      <div class="col-sm-12 d-flex flex-column">
        ...
        <Bargraph :data="total.total" :title="null" :variableObj="variableObj" :includeAxis="true" :loggable="false" :width="stackedWidth" :height="stackedHeight" :includeTooltips="true" location="World" :log="false" :percapita="false" tooltipIdx="n-main"
