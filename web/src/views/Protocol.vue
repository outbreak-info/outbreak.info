  ...
  <div class="row w-100 m-0">
    <div class="col-md-9 my-3">
      <div class="d-flex flex-column text-left">
        <div class="Protocol">
          <!-- <StripeAccent :height="20" :width="4" className="Protocol" /> -->
          Protocol
        </div>
        <!-- title -->
        ...
        <!-- source -->
        <div class="keyword-container mt-2">
          <small>Record provided by <a href="https" target="_blank" rel="noreferrer">protocols.io</a></small>
        </div>
        <!-- description -->
    ...
    <div class="col-md-3 my-3">
      <ResourceSidebar :id="data['_id']" :doi="data.doi" :date="datePublished" :url="data.url" type="Protocol" v-if="data" />
    </div>
