      ...
      <div class="my-2">
        ...
        >
          <div class="d-flex w-75 justify-content-around align-items-center">
            <div
              class="text-left d-flex align-items-center my-4 border-top border-bottom py-2 px-2 fa-lg"
            >
          ...
          <div class="w-75 mt-2 text-left">
            ...
            at Scripps Research is estimating the growth rate of SARS-CoV-2
            (hCoV-19) mutants to flag mutations worth watching. Unlike the
            <router-link :to="{ name: 'SituationReports' }">
              Variant & Mutant Tracker
            </router-link>
            or
...
import { getDateUpdated, getSequenceCount } from '@/api/genomics.js';
...
.location-banner {
  ...
  background: linear-gradient(
    ...
    left bottom darken($primary-color, 10%) no-repeat;
